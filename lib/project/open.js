...
function allocate(contents, callback)
{
...
function decode(contents, callback)
{
...
function openProject(data, callback)
{
	...
	[
		...
		function(contents, seriesCallback){   decode(contents, seriesCallback) },
		function(contents, seriesCallback){ allocate(contents, seriesCallback) }
	],
