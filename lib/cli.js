...
// example: webframes BUILD --folder asdf --export asdf.svg
...
nopter.config(
{
	...
	options:
	{
		...
		"export":
		{
			info: "The exported image (*.svg|svgz).",
			type: path
		},
		"file":
		{
		...
		/*"iterations":
		{
			info: "The number of times the animation should be played (1–n, default="+defaults.iterations+").",
			type: [Number,String]
		},*/
		/*"log":
		{
